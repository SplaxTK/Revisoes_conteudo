...
Fluxo básico de trabalho (init, add, commit)

Comandos essenciais para versionamento
...
Operações essenciais para desenvolvimento

Hospedagem Web
Diferenças entre sites estáticos e dinâmicos

Plataformas de publicação (GitHub Pages, Netlify, Vercel)

Bancos de dados e sua integração

Tipos de hospedagem disponíveis

Protocolos Web
Funcionamento do HTTPS e sua importância

Sistema de Nomes de Domínio (DNS)

Fluxo completo de uma requisição web

Segurança e criptografia na web
